...
contract ERC1155_NSBT is ERC1155, ERC2981, AccessControl, Initializable, ERC1155Supply {
        ...
        paymentProvided(amount * _runtimeConfig.publicMintPrice)
    {
        ...
        require(
            userTokensNFTPublicSale[msg.sender] + amount <= _deploymentConfig.tokenPerPerson,
    ...
    function presaleMint(uint256 amount, uint256 id, bytes memory signature)
        external
        payable
    ...
    function airdropNFTs(address[] memory _wAddress, uint256 id, uint256 amount) public virtual {
